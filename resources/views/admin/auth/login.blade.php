        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="card-body pt-0">
                        <div class="auth-logo">
                            <a href="index.html" class="auth-logo-light">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{asset('backend/images/logo-light.svg')}}" alt=""
                            ...
                            <a href="index.html" class="auth-logo-dark">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{asset('backend/images/logo.svg')}}" alt="" class="rounded-circle"
                                            height="34">
                                    </span>
                                </div>
                            </a>
                        ...
                        <div class="p-2">
                            <form class="form-horizontal" action="{{route('admin.login')}}" method="POST">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember-check" name="remember">
                                        Remember me
                                    </label>
                                </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        <p>Don't have an account ? <a href="{{url('admin/register')}}" class="fw-medium text-primary">
                                Signup now </a> </p>
                        <p>©
