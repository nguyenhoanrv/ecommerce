...
<body data-sidebar="dark">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                      <div>
                        <img src="{{asset('backend/images/megamenu-img.png')}}" alt=""
        ...
        <div class="d-flex">
          ...
          <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
              ...
              <div data-simplebar style="max-height: 230px;">
                ...
                <a href="" class="text-reset notification-item">
                  <div class="media">
                    <img src="{{asset('backend/images/users/avatar-3.jpg')}}" class="me-3 rounded-circle avatar-xs"
                      alt="user-pic">
                    <div class="media-body">
                ...
                <a href="" class="text-reset notification-item">
                  <div class="media">
                    <img src="{{asset('backend/images/users/avatar-4.jpg')}}" class="me-3 rounded-circle avatar-xs"
                      alt="user-pic">
                    <div class="media-body">
          ...
          <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item d-block" href="{{url('admin/setting')}}"><span class="badge bg-success float-end">11</span><i
              ...
              <a class="dropdown-item text-danger" href="{{route('admin.logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
  ...
  {{-- <script src="{{asset('backend/js/pages/dashboard.init.js')}}"></script> --}}
        ...
        <!-- toastr init -->
        <script src="{{asset('backend/js/pages/toastr.init.js')}}">
