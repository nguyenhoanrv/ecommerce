                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="footer-newsletter">
                            ...
                            <form action="{{ URL::to('admin/newletter/create') }}" method="POST"
                                id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"
                                class="footer-subscribe-form validate" novalidate>
                                @csrf
                                <div id="mc_embed_signup_scroll">
                                    <div id="mc-form" class="mc-form subscribe-form form-group">
                                        <input id="mc-email" name="email" type="email" autocomplete="off"
