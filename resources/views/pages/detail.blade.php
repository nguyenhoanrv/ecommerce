                ...
                <div class="col-lg-5 col-md-6" style="margin-top: 60px">
                    ...
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ $product->image_one }}"
                                    data-gall="myGallery">
                                    <img src="{{ $product->image_one }}" alt="product image" style="object-fit: cover"
                                        width="452px" height="452px">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ $product->image_two }}"
                                    data-gall="myGallery">
                                    <img src="{{ $product->image_two }}" alt="product image" style="object-fit: cover"
                                        width="452px" height="452px">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ $product->image_three }}"
                                    data-gall="myGallery">
                                    <img src="{{ $product->image_three }}" alt="product image" style="object-fit: cover"
                                        width="452px" height="452px">
                                </a>
                            </div>

                        </div>
                        <div class="product-details-thumbs slider-thumbs-1 mt-4">
                            <div class="sm-image mr-2"><img src="{{ $product->image_one }}" alt="product image thumb"
                                    style="object-fit: cover" width="113px" height="113px">
                            </div>
                            <div class="sm-image"><img src="{{ $product->image_two }}" alt="product image thumb"
                                    style="object-fit: cover" width="113px" height="113px">
                            </div>
                            <div class="sm-image ml-2"><img src="{{ $product->image_three }}" alt="product image thumb"
                                    style="object-fit: cover" width="113px" height="113px">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <span class="product-details-ref">Reference: {{ $product->brand->brand_name }}</span>
                            ...
                            <div class="price-box pt-20">
                                <span
                                    class="new-price new-price-2">{{ $product->discount_price ?? $product->selling_price }}</span>
                            </div>
                            <div class="product-desc">
                                <p>
                                    <span>{!! $product->product_details !!}
                                    </span>
                                </p>
                            </div>
                            <form class="cart-quantity" data-product-id="{{ $product->id }}">
                                ...
                                <div class="single-add-to-cart mt-4">
                                    <div class="quantity">
                                            ...
                                            <div class="modal-inner-area row">
                                                <div class="col-lg-6">
                                                    <div class="li-review-product">
                                                        <img src="{{ $product->image }}" alt="Li's Product">
